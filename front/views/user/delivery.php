...
//                    ],
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h2 class="section-name ">Дата доставки</h2>
                    ...
                    <div class="col-md-2">
                        <h2 class="section-name ">Время</h2>
                        <?= $form->field($model, 'delivery_interval')->radioList(['8-13' => '8-13', '14-19' => '14-19'])->label(false) ?>
                    </div>
                    <div class="col-md-6">
                        <h2 class="section-name ">Комментарий к заказу</h2>
                        <?= $form->field($model, 'comment')->textarea(['rows' => 14])->label(false) ?>
                    </div>
                </div>
                <div class="form-group text-right">
                    ...
                    <?= Html::submitButton('Сохранить адрес доставки и продолжить', ['class' => 'btn button']) ?>
                </div>
