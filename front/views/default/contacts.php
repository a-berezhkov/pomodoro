...
<div class="page page-contacts">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <p>Основной фокус нашей деятельности был сосредоточен на оптовых продажах в сетевые рестораны и торговые
                сети .
                В настоящее время мы развиваем розничное и мелкооптовое направление продаж. </p>
            <p> Мы не являемся перекупщиками, у нас заключены прямые контракты и партнёрские соглашения с
                производителями овощей и фруктов.</p>
            <p> 👛Благодаря этому мы поддерживаем низкий уровень цен. </p>
            <p> При этом качество продукции очень высокое, что диктуется требованиями , предъявляемыми нашими ключевыми
                клиентами.
                Мы хотим сделать покупку по-настоящему качественных продуктов доступных каждому! </p>
            Вы достойны лучшего!🔝🍅🍎</p>
            <div class="connections">
                <div class="call">
                    <p><span class="call-icon"><?= FA::i('phone'); ?></span> 8-812-921-16-06</p>
                    <p>
                        <span class="call-icon"><?= FA::i('vk'); ?></span> <?= \yii\helpers\Html::a('vk.com/signor.pomidor', 'https://vk.com/signor.pomidor') ?>
                    </p>
                    <p>
                        <span class="call-icon"><?= FA::i('instagram'); ?></span> <?= \yii\helpers\Html::a('signorpomidor.ru', 'https://www.instagram.com/signorpomidor.ru') ?>
                    </p>
